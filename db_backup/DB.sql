...
CREATE TABLE `dislikes` (
  ...
  KEY `FKdej1eqv0prsavr1warenj7ceb` (`user_id`),
...
INSERT INTO `favorite` VALUES (2,2,10);
...
INSERT INTO `items` VALUES (1,'기타','2025-08-28','egg',1,'2025-08-21',1),(3,'기타','2025-09-06','oil',3,'2025-08-30',22),(4,'채소','2025-09-06','eee',2,'2025-08-30',19),(11,'유제품','2025-09-11','egg',2,'2025-09-02',17);
...
INSERT INTO `recipe` VALUES (2,'http://example.com/eggroll.jpg','계란, 파, 소금','1. 계란을 푼다. 2. 파를 썰어 넣는다. 3. 부친다.',10,'계란말이',10,NULL,_binary '\0');
