...
class _RecipeRecommendationScreenState
  ...
  Widget _buildExpandedSection(
    ...
    final Map<String, dynamic> sectionData = _getSectionData(
      viewModel,
      sectionType,
    );
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _RecipeListItem(
                        ...
                        onTap: () => sectionData['isSelectionMode']
                            ? (sectionData['onSelectRecipe'] as Function(int))(
                                recipe.id,
                              )
  ...
  Widget _buildActionButtons(
    ...
    if (type == 'ai') {
      return Row(
        children: [
          // [수정] addFavorites -> addSelectedToFavorites 함수로 변경
          Expanded(
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              // [수정] "준비 중" 메시지 대신, addSelectedToFavorites 함수를 호출하도록 변경
              Expanded(
                child: _buildActionButton(
                  text: '즐겨찾기 추가',
                  color: const Color(0xFFFFD54F),
              ...
              Expanded(
                child: _buildActionButton(
                  ...
                  onPressed: () => ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('레시피 공유 기능은 준비 중입니다.')),
                  ),
                ),
              ),
              const SizedBox(width: 8),
